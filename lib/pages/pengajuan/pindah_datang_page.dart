...
class PindahDatangPage extends StatefulWidget {
  final LayananModel layananModel;

  const PindahDatangPage({super.key, required this.layananModel});

  @override
  State<PindahDatangPage> createState() => _PindahDatangPageState();
}

class _PindahDatangPageState extends State<PindahDatangPage> {
    ...
    Widget inputLampiran() {
      return Container(
        ...
        child: CustomChooseFile(
          titleText: "Pilih Lampiran Surat Keterangan Pindah",
