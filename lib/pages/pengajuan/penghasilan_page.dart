...
class PenghasilanPage extends StatefulWidget {
  ...
  const PenghasilanPage({super.key, required this.layananModel});

  @override
  State<PenghasilanPage> createState() => _PenghasilanPageState();
}

List<String> penghasilanList = [
  "Kurang Dari 1 Juta",
  "Kurang Dari 3 Juta",
  "Kurang Dari 5 Juta",
  "Lebih Dari 5 Juta"
...
class _PenghasilanPageState extends State<PenghasilanPage> {
  ...
  String? _extension;
  String? _fileName;
  String? penghasilan = penghasilanList[0];
  ...
  Widget build(BuildContext context) {
    ...
    Widget inputFoto() {
      return Container(
        ...
        child: CustomChooseFile(
          titleText: "Pilih Slip Gaji / Surat Keterangan",
    ...
    onSubmit(PengajuanController pengajuanController) {
      ...
      if (msg.isEmpty) {
        ...
        pengajuanController
            .postPenghasilan(PenghasilanModel(
