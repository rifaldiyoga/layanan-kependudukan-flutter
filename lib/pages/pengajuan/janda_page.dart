...
class JandaPage extends StatefulWidget {
  final LayananModel layananModel;

  const JandaPage({super.key, required this.layananModel});

  @override
  State<JandaPage> createState() => _JandaPageState();
}

class _JandaPageState extends State<JandaPage> {
    ...
    Widget inputFoto() {
      return Container(
        ...
        child: CustomChooseFile(
          titleText: "Pilih Surat Keterangan Kematian / Perceraian",
