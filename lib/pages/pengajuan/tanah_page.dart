...
class TanahPage extends StatefulWidget {
  final LayananModel layananModel;

  const TanahPage({super.key, required this.layananModel});

  @override
  State<TanahPage> createState() => _TanahPageState();
}

class _TanahPageState extends State<TanahPage> {
